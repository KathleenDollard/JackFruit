...
let appendLine text (sb : SpaceStringBuilder) = sb.AppendLine text
let increaseIndent (sb : SpaceStringBuilder)  = sb.IncreaseIndent
...
//    let appendLine text = sb.AppendLine text |> ignore
//    let increaseIndent = sb.IncreaseIndent |> ignore
//    appendLine $"{ScopeOutput mbr.Scope}{StaticOutput mbr.StaticOrInstance} {mbr.ReturnType}"
//    appendLine "{"
//    increaseIndent
